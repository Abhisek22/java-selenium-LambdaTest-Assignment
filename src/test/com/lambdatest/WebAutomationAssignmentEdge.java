...
public class WebAutomationAssignmentEdge {
	...
	public void setup() throws MalformedURLException {
		...
		ltOptions.put("smartUI.project", "LambdaTestAutomationAssignment");
		ltOptions.put("name", "Test_Automation_EdgeMac");
	...
	public void automationAssignment2() throws InterruptedException {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		WebAutomationAssignmentEdge test = new WebAutomationAssignmentEdge();
		test.setup();
		test.automationAssignment2();
		test.tearDown();
	}
